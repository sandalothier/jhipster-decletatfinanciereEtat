package com.fisc.decletatfinanciereetat.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("decletatfinanciereEtat");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("decletatfinanciereEtat");
        ...
        config.getMapConfigs().put("com.fisc.decletatfinanciereetat.domain.*", initializeDomainMapConfig(jHipsterProperties));
