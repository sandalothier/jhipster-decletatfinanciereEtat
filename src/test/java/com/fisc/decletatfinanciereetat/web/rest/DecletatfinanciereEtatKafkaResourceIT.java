...
import com.fisc.decletatfinanciereetat.DecletatfinanciereEtatApp;
...
@SpringBootTest(classes = DecletatfinanciereEtatApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecletatfinanciereEtatKafkaResourceIT {
    ...
    @Autowired
    private DecletatfinanciereEtatKafkaProducer producer;

    @Autowired
    private DecletatfinanciereEtatKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecletatfinanciereEtatKafkaResource kafkaResource = new DecletatfinanciereEtatKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decletatfinanciere-etat-kafka/publish?message=test"))
